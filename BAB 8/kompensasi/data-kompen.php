...
<body>
    ...
    <div class="table-container__datkom">
                ...
                ";
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                          ...
                          <td>
                          <button class='btn btn_detail' onclick='showDetails(\"$data[nama]\", \"$data[jenis_kompensasi]\", \"$data[biaya_kompensasi]\", \"$data[total_kompensasi]\")'>Detail</button>
                          </td>
                      </tr>
                      ";
                    }
        ...
        <div class="btn-container__datkom">
            <button class="btn__datkom" >
              <a href="../kompensasi/kompen-entry.php">Tambah Data</a>
            </button>
        </div>
        <button class="btn-simpan">
          <a href="../kompensasi/kompen-cetak.php">CETAK</a>
        </button>
    </div>
    <div class="sosmed">
