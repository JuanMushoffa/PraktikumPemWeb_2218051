...
<body>
    ...
    <div class="form-container__komentry">
        <h1>Entry Kompen</h1>
        <form id="formKompen" action="../kompensasi/kompen-proses.php" method="POST">
            <label for="nama">Nama Pegawai:</label><br>
            <input type="text" id="nama" name="nama"><br>
            <label for="jabatan">Jenis Kompensasi:</label><br>
            <input type="text" id="jabatan" name="jenis_kompensasi"><br>
            <label for="id">Biaya Kompensasi:</label><br>
            <input type="text" id="biaya" name="biaya_kompensasi"><br>
            <label for="jenis">Total Kompensasi:</label><br>
            <input type="text" id="jenis" name="total_kompensasi"><br>
            <button type="submit" name="simpan">Tambah Data</button><br><br>
            <a href="../kompensasi/data-kompen.php" target="_blank">Cek Data</a>
        </form>
    </div>
    <div class="sosmed">
