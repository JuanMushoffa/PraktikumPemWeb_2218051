...
<body>
    ...
    <div class="form-container-entol">
        <h2>Entry Total</h2>
        <form action="../total/totalentry-proses.php" method="POST" enctype="multipart/form-data">
            <input type="text" name="nama" id="nama" placeholder="Nama Pegawai"><br>
            <input type="text" name="jabatan" id="jabatan" placeholder="Jabatan Pegawai"><br>
            <input type="text" name="jenis_kompensasi" id="jenis_kompensasi" placeholder="Jenis Kompensasi"><br>
            <input type="text" name="biaya_kompensasi" id="biaya_kompensasi" placeholder="Biaya Kompensasi"><br>
            <input type="text" name="total_kompensasi" id="total_kompensasi" placeholder="Total Kompensasi"><br>
