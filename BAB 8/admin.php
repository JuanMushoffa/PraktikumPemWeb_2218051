...
<html lang="en">
  ...
  <body>
    ...
    <div class="home-content">
     ...
     <script>
        // JavaScript untuk menambahkan fungsionalitas href pada beberapa span
        document.addEventListener('DOMContentLoaded', function() {
            var spans = document.querySelectorAll('.clickable');
            
            spans.forEach(function(span) {
                var url = span.getAttribute('data-url');
                
                span.style.cursor = 'pointer'; // Mengubah kursor menjadi pointer
                span.style.color = 'blue'; // Mengubah warna teks menjadi biru
                span.style.textDecoration = 'underline'; // Menambahkan garis bawah pada teks

                span.addEventListener('click', function() {
                    window.location.href = url; // Mengarahkan ke URL ketika span diklik
                });
            });
        });
