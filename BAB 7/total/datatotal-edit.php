...
<body>
    ...
    <div class="form-container-entol">
        <h2>Edit Data Total</h2>
        <form action="../total/totalentry-proses.php" method="post" id="editForm">
        <input type="hidden" name="id" value="<?= $data['id'] ?>">
               ...
               />
                ...
                <input
                 class="input"
                 type="text"
                 name="jenis_kompensasi"
                 id="jenis_kompensasi"
                 placeholder="Jenis Kompensasi"
                 value="<?= $data['jenis_kompensasi'] ?>"
               />
               <label for="biaya_kompensasi">Biaya Kompensasi</label>
                <input
                 class="input"
                 type="text"
                 name="biaya_kompensasi"
                 id="biaya_kompensasi"
                 placeholder="Biaya Kompensasi"
                 value="<?= $data['biaya_kompensasi'] ?>"
               />
               <label for="total_kompensasi">Total Kompensasi</label>
                <input
                 class="input"
                 type="text"
                 name="total_kompensasi"
                 id="total_kompensasi"
                 placeholder="Total Kompensasi"
                 value="<?= $data['total_kompensasi'] ?>"
               />
