...
<body>
    ...
    <div class="table-container-datol">
        ...
        <table id="listTotal">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="width: 60%; text-align: center" >Action</th>
                </tr>
            </thead>
            <tbody>
                <?php
                  ...
                  while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    <td >
                      <a class='btn btn-edit' href=../total/datatotal-edit.php?id=$data[id]>
                        Edit
                      </a> | 
                      <a class='btn btn-delete' href=../total/datatotal-hapus.php?id=$data[id]>
                        Hapus
                      </a>
                    </td>
                    </tr>
        ...
        <div class="btn-container-datol">
            <button class="btn" >
                <a href="../total/entry-total.php">Tambah Data</a>
              </button>
        </div>
    </div>
    <div class="sosmed">
