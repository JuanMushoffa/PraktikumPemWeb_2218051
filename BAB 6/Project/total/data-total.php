...
<body>
          ...
          <menu class="side-nav">
            ...
            <li class="side-nav__item">
              <a href="../kompensasi/kompen-entry.php" class="side-nav__link">
                ...
                <span id="clickable" class="text" data-url="../BAB 2/kompensasi/data-kompen.html">Kompen Entry</span>
              </a>
            </li>
            <li class="side-nav__item">
    ...
    <div class="table-container-datol">
        ...
        <table id="listTotal">
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                  ...
                  <td>$data[biaya_kompensasi]</td>
                  <td>$data[total_kompensasi]</td>
                  </tr>
                ";
                }
                ?>
        ...
        <!-- Button untuk kembali ke halaman entry-total.html -->
        <div class="btn-container-datol">
            <button class="btn" onclick="window.location.href='entry-total.html'">Tambah Data</button>
        </div>
    </div>

    <div class="popup-container-datol" id="editPopup">
        <div class="popup-content-datol">
            <h2>Edit Data</h2>
            <form id="editForm">
                ...
                <input type="text" id="editTunjangan" placeholder="Biaya Kompensasi"><br>
                <input type="text" id="editTotal" placeholder="Total Kompensasi"><br>
